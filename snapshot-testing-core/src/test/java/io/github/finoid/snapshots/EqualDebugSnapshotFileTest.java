...
public class EqualDebugSnapshotFileTest {
    ...
    private static final String SNAPSHOT_FILE_PATH =
        "src/test/java/io/github/finoid/snapshots/__snapshots__/EqualDebugSnapshotFileTest.snap";
    private static final String DEBUG_FILE_PATH =
        "src/test/java/io/github/finoid/snapshots/__snapshots__/EqualDebugSnapshotFileTest.snap.debug";
