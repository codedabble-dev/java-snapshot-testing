...
public class EmptySnapshotFileTest {
    ...
    private static final String SNAPSHOT_FILE_PATH =
        "src/test/java/io/github/finoid/snapshots/__snapshots__/EmptySnapshotFileTest.snap";
    private static final String DEBUG_FILE_PATH =
        "src/test/java/io/github/finoid/snapshots/__snapshots__/EmptySnapshotFileTest.snap.debug";
    ...
    public class NestedClass {
        ...
        private static final String SNAPSHOT_FILE_PATH_NESTED =
            "src/test/java/io/github/finoid/snapshots/__snapshots__/EmptySnapshotFileTest$NestedClass.snap";
        private static final String DEBUG_FILE_PATH_NESTED =
            "src/test/java/io/github/finoid/snapshots/__snapshots__/EmptySnapshotFileTest$NestedClass.snap.debug";
