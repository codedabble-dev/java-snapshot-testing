...
class DebugSnapshotLineEndingsTest {
    ...
    private static final String DEBUG_FILE_PATH =
        "src/test/java/io/github/finoid/snapshots/__snapshots__/DebugSnapshotLineEndingsTest.snap.debug";
    private static final String SNAPSHOT_FILE_PATH =
        "src/test/java/io/github/finoid/snapshots/__snapshots__/DebugSnapshotLineEndingsTest.snap";
    ...
    private static class MultiLineSnapshotSerializer implements SnapshotSerializer {
        ...
        public Snapshot apply(Object object, SnapshotSerializerContext snapshotSerializerContext) {
            ...
            return Snapshot.builder()
                .name(
                    "io.github.finoid.snapshots.DebugSnapshotLineEndingsTest.existingSnapshotDifferentLineEndings")
                .body(body.toString())
                .build();
        }
    }
