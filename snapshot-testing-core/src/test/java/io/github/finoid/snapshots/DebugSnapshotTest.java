...
public class DebugSnapshotTest {
    ...
    private static final String DEBUG_FILE_PATH =
        "src/test/java/io/github/finoid/snapshots/__snapshots__/DebugSnapshotTest.snap.debug";
    private static final String SNAPSHOT_FILE_PATH =
        "src/test/java/io/github/finoid/snapshots/__snapshots__/DebugSnapshotTest.snap";
